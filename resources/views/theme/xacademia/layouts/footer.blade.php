                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-12">
                            ...
                            <ul class="list-unstyled mb-0 mt-4">
                                ...
                                <li>
                                    <a href="javascript:void(0)">{{ setting('contact_email') }} </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">{{ setting('contact_phone') }}</a>
                                </li>
                            </ul>
            ...
            <div class="row">
                <div class="col-lg">
                    <ul class="payments mb-0 mt-2">
                        <li>
                            <a href="javascript:void(0)" class="payments-icon text-white-50"><i class="fa fa-cc-amex"
                                    aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="payments-icon text-white-50"><i class="fa fa-cc-visa"
                                    aria-hidden="true"></i></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="javascript:void(0)" class="payments-icon text-white-50"><i
                                    class="fa fa-cc-discover" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="payments-icon text-white-50"><i
                                    class="fa fa-google-wallet" aria-hidden="true"></i></a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row d-flex">
                <div class="col-lg-12 col-sm-12  mt-2 mb-2 text-center text-white">
                    @if (!empty(setting('copyright')))
                        {!! setting('copyright') !!}
                    @else
                        Copyright © {{ now()->year }} <a href="javascript:void(0)"
                            class="fs-14 text-primary">{{ env('APP_NAME') }}</a>. All rights reserved.
                    @endif
                </div>
            </div>
        </div>
