        ...
        <div class="sticky">
            <div class="horizontal-header clearfix ">
                <div class="container">
                    ...
                    <span class="smllogo"><img src="{{ asset('theme/xacademia/assets/images/brand/logo1.png') }}" width="120"
                            alt="img" /></span>
        ...
        <div class="horizontal-main header-style1 p-0 bg-dark-transparent clearfix">
            <div class="horizontal-mainwrapper container clearfix">
                <div class="desktoplogo">
                    <a href="index.html"><img src="{{ asset('theme/xacademia/assets/images/brand/logo1.png') }}" alt="img">
                    </a>
                </div>
                ...
                <nav class="horizontalMenu clearfix d-md-flex">
                    <ul class="horizontalMenu-list">
                        ...
                        <li aria-haspopup="true"><a href="javascript:void(0)" class="active">Course <span
                                    class="fe fe-chevron-down"></span></a>
