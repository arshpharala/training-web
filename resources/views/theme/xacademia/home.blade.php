					...
					<div class="row">
						<div class="col-xl-10 col-lg-12 col-md-12">
							<div class="text-white mb-7">
								<a href="" class="typewrite" data-period="2000" data-type='[ "Find The Best Trainers and Build Your Future" ]'>
...
<section class="sptb">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="video-img">
                    <img src="{{ asset('theme/xacademia/assets/images/media/video.jpg') }}" alt="img"
                        class="cover-image br-7">
            ...
            <div class="col-md-6">
                <div class="video-section mt-8 ms-lg-5 pt-5">
                    ...
                    <p class="lead leading-normal mt-4">Many desktop publishing packages and web page editors now use
                ...
                <div class="card mb-0 overflow-hidden">
                    <div class="card-body">
                        <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><img
                                    src="{{ asset('theme/xacademia/assets/images/png/power.png') }}" class=""></span>
                        </div>
                        <img src="{{ asset('theme/xacademia/assets/images/media/color/sm/6.jpg') }}" alt="img"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 met-sm-2">
                        <div class="student-img ">
                            <img src="{{ asset('theme/xacademia/assets/images/png/19.png') }}" class="" alt="img">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card overflow-hidden gallery-item">
                            <div class="card-body">
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <span class="font-weight-bold"><strong
                                            class="fs-18 font-weight-bold">656</strong> Over Courses</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card overflow-hidden gallery-item">
                            <div class="card-body">
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <span class="font-weight-bold"><strong
                                            class="fs-18 font-weight-bold">875</strong> Over Courses</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card overflow-hidden gallery-item">
                            <div class="card-body">
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <span class="font-weight-bold"><strong
                                            class="fs-18 font-weight-bold">856</strong> Over Courses</span>
                                </div>
                            </div>
                        </div>
                    </div>
