<form action="{{ route('admin.catalog.delivery-methods.store') }}" method="post" class="ajax-form" enctype="multipart/form-data"
  onsubmit="handleFormSubmission(this)">
  @csrf
  @include('theme.adminlte.components._aside-header', [
      'moduleName' => __('crud.create_title', ['name' => 'Delivery Method']),
  ])
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input type="text" name="shot_description" class="form-control" required>
          </div>
          ...
          <div class="form-group">
            ...
            @if (isset($deliveryMethod) && $deliveryMethod->icon)
              <div class="mt-2">
